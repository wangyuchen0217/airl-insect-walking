...
from expert import load_cheetah_expert
from airl import train_airl, visualize_trained_agent

# Use GPU if available
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

ENV_NAME = "HalfCheetah-v4"  # Use a Mujoco-based Gymnasium environment
...
expert_states, expert_actions, expert_next_states = load_cheetah_expert()
