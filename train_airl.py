'''
This script trains an AIRL agent in a CoppeliaSim environment using expert demonstrations.
'''
...
ALGO = "airl_logit_vx"
MEMO = "Continue from 20251115-1104 step 470000, logit + vx * 100, body(w/o x,y,z) + joint + contact(force)"
