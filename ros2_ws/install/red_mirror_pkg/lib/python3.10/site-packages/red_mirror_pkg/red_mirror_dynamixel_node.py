...
DXL_ID_ThC_LIST = [11, 21 ,31, 41, 51, 61]
...
DXL_init_positions = [
                        0.5235988,   0.1658063,  -1.0471976,  # 30,   9.5, -60  LF
                        0.0000000,  -0.0436332,  -1.0471976,  #  0,  -2.5, -60  LM
                        -0.6981317,   0.1658063,  -1.0471976,  # -40,  9.5, -60  LH
                        0.5235988,   0.1658063,  -1.0471976,  # 30,   9.5, -60  RF
                        0.0000000,  -0.0436332,  -1.0471976,  #  0,  -2.5, -60  RM
                        -0.6981317,   0.1658063,  -1.0471976,  # -40,  9.5, -60  RH
]
...
# DECENAME              = '/dev/ttyUSB0'

# Velocity profile written once on connect
DEFAULT_VELOCITY_TICKS  = 200
...
class RedMirrorDXLController(Node):
    def __init__(self):
        ...
        self._open_port()
        self._scan_motors()
        self._enable_torque()  # ============================ Disable for testing ============================
