...
ALGO = "ppo-transfer"
MEMO = "Memo: Continue after 20251115-1605 step 250000, g(s) + vx * 100, body(w/o x,y,z) + joint + contact(force), g(s) from 'logs/Medauroidea_66k_aug3c/airl_logit_vx/20251101-1111/model/step460000/discriminator.pth'"
