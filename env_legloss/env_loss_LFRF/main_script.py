...
def sysCall_sensing():
    ...
    sim.setGraphStreamValue(self.graph_ThC, self.FL_ThC, 0)
    ...
    sim.setGraphStreamValue(self.graph_ThC, self.FR_ThC, 0)
    ...
    sim.setGraphStreamValue(self.graph_CTr, self.FL_CTr, 0)
    ...
    sim.setGraphStreamValue(self.graph_CTr, self.FR_CTr, 0)
    ...
    sim.setGraphStreamValue(self.graph_FTi, self.FL_FTi, 0)
    ...
    sim.setGraphStreamValue(self.graph_FTi, self.FR_FTi, 0)
    ...
    sim.setGraphStreamValue(self.graph_force, self.FL_force, 0)
    ...
    sim.setGraphStreamValue(self.graph_force, self.FR_force, 0)
    ...
    sim.setGraphStreamValue(self.graph_foot, self.FL_foot, 0)
    ...
    sim.setGraphStreamValue(self.graph_foot, self.FR_foot, 0)
