...
def sysCall_sensing():
    ...
    sim.setGraphStreamValue(self.graph_ThC, self.MR_ThC, 0)
    ...
    sim.setGraphStreamValue(self.graph_CTr, self.MR_CTr, 0)
    ...
    sim.setGraphStreamValue(self.graph_FTi, self.MR_FTi, 0)
    ...
    sim.setGraphStreamValue(self.graph_force, self.MR_force, 0)
