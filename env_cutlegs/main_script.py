...
def sysCall_init():
    ...
    self.csv_file = "/home/yuchen/airl-insect-walking/env_cutlegs/Animal06_110919_00_31.csv"
    self.df = pd.read_csv(self.csv_file)
    self.df_final_line = len(self.df['LM_CTr'])
    print(self.df_final_line)
    
    self.leg_names = ['/ML','/HL','/MR','/HR'] # type: ignore
    ...
    self.foot_contact_sensors = [self.ML_foot_contact_sensor,
    ...
    self.foots = []
    self.foot_names = ['/foot_ML', '/foot_HL', '/foot_MR', '/foot_HR']
    for i in range(4):
    ...
    self.force_sensors_values_xyz = [self.ML_force_sensor_values_xyz ,self.HL_force_sensor_values_xyz , self.MR_force_sensor_values_xyz ,self.HR_force_sensor_values_xyz]
    self.force_sensors_values_z_filter = [0, 0, 0, 0]
...
def sysCall_sensing():
    ...
    ML_foot_traj = sim.getObjectPosition(self.foots[0])
    HL_foot_traj = sim.getObjectPosition(self.foots[1])
    MR_foot_traj = sim.getObjectPosition(self.foots[2])
    HR_foot_traj = sim.getObjectPosition(self.foots[3])
    ...
    if self.logging:
        ...
        self.data_list['force_ML'].append(self.force_sensors_values_z_filter[0])
        self.data_list['force_HL'].append(self.force_sensors_values_z_filter[1])
        self.data_list['force_MR'].append(self.force_sensors_values_z_filter[2])
        self.data_list['force_HR'].append(self.force_sensors_values_z_filter[3])

        self.data_list['force_ML_x'].append(self.force_sensors_values_xyz[0][0])
        self.data_list['force_ML_y'].append(self.force_sensors_values_xyz[0][1])
        self.data_list['force_ML_z'].append(self.force_sensors_values_xyz[0][2])
        self.data_list['force_HL_x'].append(self.force_sensors_values_xyz[1][0])
        self.data_list['force_HL_y'].append(self.force_sensors_values_xyz[1][1])
        self.data_list['force_HL_z'].append(self.force_sensors_values_xyz[1][2])
        self.data_list['force_MR_x'].append(self.force_sensors_values_xyz[2][0])
        self.data_list['force_MR_y'].append(self.force_sensors_values_xyz[2][1])
        self.data_list['force_MR_z'].append(self.force_sensors_values_xyz[2][2])
        self.data_list['force_HR_x'].append(self.force_sensors_values_xyz[3][0])
        self.data_list['force_HR_y'].append(self.force_sensors_values_xyz[3][1])
        self.data_list['force_HR_z'].append(self.force_sensors_values_xyz[3][2])
...
def sysCall_cleanup():
    ...
    if self.logging:
        ...
        save_data.to_csv('/home/yuchen/airl-insect-walking/expert_cutlegs.csv', index=False)
