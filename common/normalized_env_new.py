...
class CoppeliaSimEnv:
    ...
    OBS_SPEC: tuple[ObsField, ...] = (
                    ...
                    ObsField('joint_angles', 18,  'get_jointangle',     'per_dim',
                                low=np.array([
                                    -1.3860602, 0.06034265, -2.3490806, -0.69396245, -0.0351965, -2.2783134,
                                    0.33121786, 0.2596617, -2.507828, 0.5072578, -0.7540891, 0.5758628,
                                    -0.6832747, -0.6967423, 0.64540935, -1.2671623, -0.9981095, 0.58814275
                                ]),  
                                high=np.array([
                                    -0.6099888, 0.63728195, -0.7725696, 0.65703726, 0.48784378, -1.0506248,
                                    1.1966776, 1.0010364, -0.8661594, 1.1699893, -0.10950406, 2.4969175,
                                    0.9650939, -0.00942995, 2.3240883, -0.28500196, -0.15376441, 2.3464022
                                ]),
                                include=True),
                    ...
                    ObsField('qvel_joints', 18, 'get_qvel_joints', 'per_dim',
                            low=np.array([
                                -6.3401504, -4.757705, -6.287696, -6.3208895, -3.3226593, -6.284912,
                                -5.5638685, -3.3805063, -6.2904396, -1.3104646, -2.12268, -6.292333,
                                -4.97185, -6.2946496, -6.28743, -4.3283315, -6.048407, -4.8578815
                            ]),
                            high=np.array([
                                1.9682697, 2.6865423, 6.2905607, 6.38855, 4.8199844, 6.2897816,
                                2.7990909, 6.3629537, 4.786763, 5.29868, 5.7314405, 3.564882,
                                6.403282, 2.612296, 6.2867584, 6.2795334, 3.2040458, 6.287452
                            ]),
                            include=True),
    ...
    action_space_high = np.array([
                        ...
                        0.44833541,  -0.0290928, 1.59938887
                        ])
