...
def sysCall_sensing():
    ...
    sim.setGraphStreamValue(self.graph_CTr, self.FL_CTr, self.FL_joints_postions[1]*(-1))
    sim.setGraphStreamValue(self.graph_CTr, self.ML_CTr, self.ML_joints_postions[1]*(-1))
    sim.setGraphStreamValue(self.graph_CTr, self.HL_CTr, self.HL_joints_postions[1]*(-1))
    ...
    sim.setGraphStreamValue(self.graph_FTi, self.FL_FTi, self.FL_joints_postions[2]*(-1))
    sim.setGraphStreamValue(self.graph_FTi, self.ML_FTi, self.ML_joints_postions[2]*(-1))
    sim.setGraphStreamValue(self.graph_FTi, self.HL_FTi, self.HL_joints_postions[2]*(-1))
